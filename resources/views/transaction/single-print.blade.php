    ...
    <div class="row" style="max-height:150mm !important;">
        <div style="max-width:72mm !important;  margin: 0 auto 0 auto; vertical-align: top; border-style: solid;border-width: 1px;">
            ...
            <div style="widht:72mm; font-size:8pt; padding:2mm 0 2mm 0; margin-top: 40px; margin-bottom: 0px; ">
                ...
                @if($transaction->detail()->where('ticket_id',13)->first())
                ...
                <p style="font-size:10pt;margin-left:10px;margin-top:5px;margin-bottom:0px">Jumlah <span style="float: right; margin-right: 20px;"> {{ number_format($transaction->detail()->sum('total'), 0 , ',', '.') }}</span></p>

                <p style="font-size:10pt;margin-left:10px;margin-top:5px;margin-bottom:0px">Discount ({{ $transaction->discount }}%)
                    @php
                ...
                <p style="font-size:10pt;margin-left:10px;margin-top:5px;margin-bottom:0px">Total Bayar <span style="float: right; margin-right: 20px; font-weight: bold;">Rp. {{ number_format($transaction->detail()->sum('total') - $discount, 0 , ',', '.') }}</span></p>

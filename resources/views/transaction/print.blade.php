    ...
    <div class="row">
        <div style="max-width:80mm !important;  margin: 0 auto 0 auto; vertical-align: top; border-style: solid;border-width: 1px;">
            ...
            <div style="widht:80mm; font-size:8pt; padding:2mm 0 2mm 0; margin-top: 60px; margin-bottom: 0px; ">
                ...
                <hr style="border-style: dashed;">
                <p style="font-size:6.5pt;text-align: center;margin-top:5px">RIO WATERPARK " Tiket berlaku satu kali masuk "</p>
                <hr style="border-style: dashed;">
                ...
                <hr style="border-style: dashed;">
                <p style="font-size:6.5pt;text-align: center;margin-top:5px;margin-bottom:0px">RIO WATERPARK " Barcode hanya buat buka gate "</p>
            </div>
            {{--
    ...
    @for($i=0; $i<$print;$i++) @foreach($tickets as $ticket) <div class="row">
        <div style="max-width:80mm !important;  margin: 0 auto 0 auto; vertical-align: top; border-style: solid;border-width: 1px;">
            ...
            <div style="widht:80mm; font-size:8pt; padding:2mm 0 2mm 0; margin-top: 60px; margin-bottom: 0px; ">
                ...
                <br><br>
                <p style="font-size:10pt;margin-left:30px;margin-top:5px;margin-bottom:0px">Pengunjung <span style="float: right; margin-right: 20px;">{{ $ticket->tipe == 'group' ? $ticket->amount . ' X ' . number_format($ticket->ticket->harga, 0, ',', '.') : $ticket->amount }}</span></p>
                <p style="font-size:10pt;margin-left:30px;margin-top:5px;margin-bottom:0px">Total <span style="float: right; margin-right: 20px; font-weight: bold;">Rp. {{ number_format($ticket->ticket->harga*$ticket->amount, 0 , ',', '.') }}</span></p>
